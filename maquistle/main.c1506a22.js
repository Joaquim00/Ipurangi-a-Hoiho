(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
    ...
    var Ba = "abcçdefghijlmnopqrstuvxzʼ",
              ...
              value: function () {
				...
				.concat(Pa(t + 1), " 字母要係 ")
                    ...
                    if (!o)
                      return (
                        a.setAttribute("invalid", ""),
                        void this.addToast(n || "Não é válido no modo difícil 困難模式唔用得")
                      );
                  }
                  var r = (function (e, a) {
                    for (
                  ...
                  this.shadowRoot
                    ...
                    .addEventListener("click", function (a) {
                      var s = e.$game.querySelector("game-page"),
                        t = document.createTextNode("OPÇÕES 設定");
                      s.appendChild(t);
  ...
  ***************************************************************************** */
                        ...
                        As(
                          (function (e) {
                            ...
                            return (
                              ...
                              { text: "".concat(l, "\n\n").concat(d.trimEnd()).concat("\n\nhttps://hilario.bambooradical.com/maquistle/") }
                            );
                          })({
    ...
    Ps.innerHTML =
      '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Estungʼa sâm ungʼa wordle di Maquista / Patuá di Macau!</p>\n      <p>Este é um wordle em Patuá macaense! 呢個係一個澳門土生葡語嘅 wordle!</p>\n      <p>Esta é a versão <strong>FÁCI</strong> (fácil; accentos nas vogais são ignorados); clique na <a href="https://joaquim00.github.io/maquistle/d/" target="blank">versão <strong>TRABALO</strong></a> (difícil) se você ousar. 呢個係 <strong>FÁCI</strong> 版 (容易; 唔使理元音啲蟲蟲)；你大膽嘅就撳 <a href="https://joaquim00.github.io/maquistle/d/" target="blank"><strong>TRABALO</strong> 版</a> (難)。</p>\n      <p>Advinha o <strong>Maquistle</strong> em 6 tentativas！ 喺六次之內估中今日嘅 <strong>Maquistle</strong>！</p>\n      <p>Cada tentativa tem de ser uma palavra de 5 letras. Usa o botão Enter ↵ para submeter. 每一次估嘅答案都一定要係五個字母嘅詞，撳 ENTER ↵ 掣就可以提交。</p>\n      <p>Depois de cada tentativa, a cor dos quadrados mudará para mostrar quão perto estás da solução. 每次提交答案之後，啲方格會變成唔同嘅顏色，作為你下一次估嘅提示。</p>\n      <div class="examples">\n        <p><strong>Exemplos 例子</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="m" evaluation="correct" reveal></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="c"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="u"></game-tile>\n          </div>\n          <p>A letra <strong>M</strong> está na palavra e na posição correta. 個答案有 <strong>M</strong> 呢個字母，而且位置正確。</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="l"></game-tile>\n            <game-tile letter="i" evaluation="present" reveal></game-tile>\n            <game-tile letter="ç"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="m"></game-tile>\n          </div>\n          <p>A letra <strong>I</strong> está na palavra mas na posição errada. 個答案有 <strong>I</strong> 呢個字母，但係位置唔啱。</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="f"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="h"></game-tile>\n            <game-tile letter="o"></game-tile>\n            <game-tile letter="c" evaluation="absent" reveal></game-tile>\n          </div>\n          <p>A letra <strong>C</strong> não está na palavra. 答案裏面冇 <strong>C</strong> 呢個字母。</p>\n        </div>\n      <p>Notas 注意: 1. O accentos agudo (ʹ) e circunflexo (^) são ignorados (na versão FÁCI). (FÁCI 版: ) 開音符 (ʹ) 同閉音符 (^) 唔使理; 2. O hífen é ignorado. 連字號唔使理; 3. O dígrafo <strong>RR</strong> não existe na ortografia macaense. 澳門土生葡語冇 <strong>RR</strong> 呢個二合字母。</p>\n      </div>\n      <p>Adaptação do <a href="https://www.powerlanguage.co.uk/wordle" target="blank">Wordle</a> de Josh Wardle por <a href="https://hilario.bambooradical.com" target="blank">Hilário de Sousa</a>. 呢個遊戲原版係 Josh Wardle 設計嘅 <a href="https://www.powerlanguage.co.uk/wordle" target="blank">Wordle</a>，由 <a href="https://hilario.bambooradical.com" target="blank">Hilário de Sousa</a> 改版。</p>\n      <p>Mercê 鳴謝: <a href="https://samuello.io/jndle/" target="blank">JNDLE 字道</a>, <a href="https://facle.netlify.app" target="blank">FACLE</a>, <a href="https://palavra-do-dia.pt" target="blank">Palavra do Dia</a>, <a href="https://www.facebook.com/lingumaquista" target="blank">Unchinho di Língu Maquista</a>.</p>\n      <p>Most words extracted from: Miguel Senna Fernandes & Alan Norman Baxter (2001). Maquista Chapado – vocabulário e expressões do crioulo português de Macau. Macau: Instituto Internacional de Macau. An abridged <a href="https://www.macaneselibrary.org/pub/english/uipatua.htm" target="blank">electronic version</a>. <a href="https://hilario.bambooradical.com/maquistle/maquistle_list.txt" target="blank">Cheat sheet</a>.      </div>\n      </div>\n      <p><strong>Há uma nova Maquistle por dia! 每日都會有新嘅 Maquistle！</strong></p>\n      </section>\n';
    var Hs = (function (e) {
      r(t, e);
      var a = h(t);
      function t() {
