(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
    ...
    Sa.innerHTML =
      '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Difficult Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses
                ...
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                  ...
                  if (((e = s), !Ta.includes(e) && !La.includes(e)))
                    return (
                      ...
                      void this.addToast("Two hamsters must not be next to each other!")
                    );
                  if (this.hardMode) {
                        ...
                        for (var t = 0; t < s.length; t++)
                          if (s[t] === Ma && e[t] !== a[t])
                            return {
                              validGuess: !1,
                              errorMessage: ""
                                .concat(Pa(t + 1), " position needs to be ")
                        ...
                        for (var i in o)
                          if ((r[i] || 0) < o[i])
                            return {
                              validGuess: !1,
                              errorMessage: "" 
				    .concat("The answer needs to have a ")
                    ...
                    if (!o)
                      return (
                        a.setAttribute("invalid", ""),
                        void this.addToast(n || "Not valid in Difficult mode!")
                      );
                  }
                  var r = (function (e, a) {
                    for (
                ...
                if (this.gameStatus === Za && this.canInput) {
                  if (5 !== this.tileIndex)
                    return (
                      ...
                      void this.addToast("All five positions needs to be filled!")
                    );
                  this.evaluateRow();
                }
              },
                    ...
                    function (a) {
                      ...
                      switch (t) {
                        case "hard-mode":
                          return void (n
                            ? e.addToast(
                                "Difficult mode can only be switched on before a game!",
                                1500,
                                !0
                              )
  ...
  ***************************************************************************** */
                        ...
                        As(
                          (function (e) {
                            ...
                            return (
                              ...
                              { text: "".concat(l, "\n\n").concat(d.trimEnd()).concat("\n\nhttps://hilario.bambooradical.com/hamsterpoopdle/") }
                            );
                          })({
    ...
    Ps.innerHTML =
      '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Welcome to 🐹💩dle Hamsterpoopdle!</p>\n      <p>Guess todayʼs <strong>🐹💩dle</strong> in 6 tries!</p>\n      <p>Each of the five cells have to be filled by 🐹 hamster, 💩 poop, or ❌ blank space.</p>\n      <p>After entering your guess, the colour of the cell is a hint for your next guess.</p>\n      <div class="examples">\n        <p><strong>Exemplos 例子</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="🐹" evaluation="correct" reveal></game-tile>\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="❌"></game-tile>\n            <game-tile letter="❌"></game-tile>\n          </div>\n          <p><strong>🐹</strong> is in the correct answer and is in the correct position.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="💩" evaluation="present" reveal></game-tile>\n            <game-tile letter="🐹"></game-tile>\n            <game-tile letter="❌"></game-tile>\n            <game-tile letter="🐹"></game-tile>\n          </div>\n          <p><strong>💩</strong> is in the correct answer but is in the wrong position.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="🐹"></game-tile>\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="❌" evaluation="absent" reveal></game-tile>\n          </div>\n          <p><strong>❌</strong> is not in the answer.</p>\n        </div>\n      <p>Notes: 1. The number of 🐹s can be zero (sometimes they are not at home); 2. 🐹s are territorial; they cannot be right next to each other; 3. The number of 💩s can be zero to five; 4. All other spaces must be filled in by ❌s.</p>\n      </div>\n      <p>Adapted from Josh Wardleʼs <a href="https://www.powerlanguage.co.uk/wordle" target="blank">Wordle</a> by <a href="https://hilario.bambooradical.com" target="blank">Hilário de Sousa</a>.</p>\n      <p>Mercê: 🐹💩dle is forked from Samuel Loʼs <a href="https://samuello.io/jndle/" target="blank">JNDLE 字道</a></p>\n      \n      <p>Want to support? <a href="https://ko-fi.com/hilariodesousa" target="blank">Buy me a coffee/tea! ☕</a></p>      </div>\n      </div>\n      <p><strong>A new 🐹💩dle everyday!</strong></p>\n      </section>\n';
    var Hs = (function (e) {
      r(t, e);
      var a = h(t);
      function t() {
