(this.wordle = this.wordle || {}),
                ...
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                  ...
                  if (((e = s), !Ta.includes(e) && !La.includes(e)))
                    return (
                      ...
                      void this.addToast("Hamsters must not be next to each other!")
                    );
                  if (this.hardMode) {
                        ...
                        for (var t = 0; t < s.length; t++)
                          if (s[t] === Ma && e[t] !== a[t])
                            return {
                              validGuess: !1,
                              errorMessage: ""
                                .concat(Pa(t + 1), " position must be ")
                        ...
                        for (var i in o)
                          if ((r[i] || 0) < o[i])
                            return {
                              validGuess: !1,
                              errorMessage: "" 
				    .concat("The configuration needs to have ")
                ...
                if (this.gameStatus === Za && this.canInput) {
                  if (5 !== this.tileIndex)
                    return (
                      ...
                      void this.addToast("All the spaces need to be filled!")
                    );
                  this.evaluateRow();
                }
              },
                    ...
                    function (a) {
                      ...
                      switch (t) {
                        case "hard-mode":
                          return void (n
                            ? e.addToast(
                                "Difficult mode can only be activated at the beginning of a game.",
                                1500,
                                !0
                              )
  ...
  ***************************************************************************** */
    ...
    Ps.innerHTML =
      '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Welcome to 🐹💩-DLE!</p>\n      <p>Guess todayʼs <strong>🐹💩-DLE</strong> in 6 tries!</p>\n      <p>Fill each square with 🐹 hamster, 💩 poop, or ❌ empty space; Press the Enter ↵ button to submit.</p>\n      <p>After each guess, the colour of the squares changes to show you how close you are to the correct answer.</p>\n      <div class="examples">\n        <p><strong>Examples</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="🐹" evaluation="correct" reveal></game-tile>\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="❌"></game-tile>\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="❌"></game-tile>\n          </div>\n          <p>🐹 is in the answer, and it is in the correct position</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="❌"></game-tile>\n            <game-tile letter="💩" evaluation="present" reveal></game-tile>\n            <game-tile letter="🐹"></game-tile>\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="🐹"></game-tile>\n          </div>\n          <p>💩 is in the answer, but the position is not correct.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="🐹"></game-tile>\n            <game-tile letter="💩"></game-tile>\n            <game-tile letter="❌" evaluation="absent" reveal></game-tile>\n          </div>\n          <p>❌ is not in the answer.</p>\n        </div>\n      <p>Notes: 1. (Adult) hamsters are mostly solitary, do not place two hamsters right next to each other; 2. the number of hamsters can be zero (sometimes they are not home); 3. the number of poops and crosses (empty spaces) can be anywhere from zero to five.</p>\n      </div>\n      <p>Adopted by <a href="https://hilario.bambooradical.com" target="blank">Hilário de Sousa</a> from Josh Wardleʼs <a href="https://www.powerlanguage.co.uk/wordle" target="blank">Wordle</a>.</p>\n      <p>Mercê: 🐹💩-DLE is forked from Samuel Loʼs <a href="https://samuello.io/jndle/" target="blank">JNDLE 字道</a></p>\n      <p>Want to support? <a href="https://ko-fi.com/hilariodesousa" target="blank">Buy me a coffee/tea! ☕</a></p>      </div>\n      </div>\n      <p><strong>A new 🐹💩-DLE everyday!</strong></p>\n      </section>\n';
    var Hs = (function (e) {
      r(t, e);
      var a = h(t);
      function t() {
